...
exports.go = function(cfg, commandSet, cb) {
    ...
    async.waterfall([
        ...
        //
        // Print output status (success, warnings, errors) to console.
        //
        ...
        var f = function(finished) {
            ...
            fn(p, cmd2, args2, function(err, summary) {
                ...
                if (err) {
                    ...
                    // Command success. Add to package's messages array for later reporting.
 ...
 * @param {String}   path folder of module (where is package.json resides)
